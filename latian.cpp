...
<body id="page-top">
  <nav class="navbar navbar-expand-lg navbar-custom fixed-top" id="mainNav">
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#page-top">[WGTIK 2022]</a>
      ...
      <div class="row">
        <div class="col-lg-10 mx-auto">
          <h1 class="text-uppercase">
            <strong>ANNISA RAHMA DARMAWAN</strong>
          </h1>
          <hr class="divider my-4" />
        </div>
        <div class="col-lg-8 mx-auto">
          <p class="text-faded text-black mb-5">A fresh graduate student who is passionate about trying new things and likes to seek new experiences.</p>
          <p class="text-italic font-weight-bold mb-5">Jalanin aja dulu</a></p>
          <a class="btn btn-primary btn-xl js-scroll-trigger" href="#about">MORE INFORMATION ABOUT ME!</a>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 text-center div-padding-fix mb-4">
          ...
          <p class="text-faded">Not Graduate yet</p>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 text-center mb-4">
          ...
          <h3 class="text-white">Skills</h3>
					<p class="text-faded">[Data Analyst]</p>
        </div>
      </div>
    ...
    <div class="container-fluid p-0">
      <div class="row no-gutters">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading" id="work">Organization Experience</h2>
          <hr class="divider my-4" />
        </div>
	      <div class="col-sm-12 text-center mt-4 mb-4">
          <i class="fa fa-4x fa-rocket text-primary sr-icons">Inter-Fest 2022</i>
          <h3 class="mt-4 mb-4">[]</h3>
          <p class="text-muted">[September 2022] to [December 2022]: <span class="RtnRed">[Organization]</span></p>
        </div>
        <div class="col-lg-3 col-sm-6 text-center">
          <i class="fa fa-4x fa-fighter-jet text-primary sr-icons"></i>
          <h3 class="mt-4 mb-4">[PORSENIF]</h3>
          <p class="text-muted">[November 2021] to [December 2021]: [Telkom University]</p>
        </div>
        <div class="col-lg-3 col-sm-6 text-center">
          <i class="fa fa-4x fa-fighter-jet text-primary sr-icons"></i>
          <h3 class="mt-4 mb-4">[PPUH]</h3>
          <p class="text-muted">[December 2021] to [March 2022]: [Telkom University]</p>
        </div>
        <div class="col-lg-3 col-sm-6 text-center">
          <i class="fa fa-4x fa-android text-primary sr-icons"></i>
          <i class="fa fa-4x fa-server text-primary sr-icons ml-4"></i>
          <h3 class="mt-4 mb-4">STAFF MUDA BADAN HIMPUNAN MAHASISWA TELKOM UNIVERSITY</h3>
          <p class="text-muted mb-4">[2022]: [Telkom University]</p>
        </div>
        <div class="col-lg-3 col-sm-6 text-center">
          <i class="fa fa-4x fa-pied-piper text-primary sr-icons"></i>
          <h3 class="mt-4 mb-4">Research Assistant</h3>
          <p class="text-muted">[2022]: [Telkom University]</p>
        </div>
      </div>
  ...
  <div class="container">
    <p class="text-center text-muted text-small mb-1">
     Annisa Rahma Darmawan &copy; 2023 - <span id="copyright-year"></span>. All rights reserved.
